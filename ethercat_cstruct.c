...
ec_pdo_info_t slave_7_pdos[] = {
    {0x1600, 19, slave_7_pdo_entries + 0}, /* Outputs */
    {0x1a00, 21, slave_7_pdo_entries + 19}, /* Inputs */
};

ec_sync_info_t slave_7_syncs[] = {
    {0, EC_DIR_OUTPUT, 1, slave_7_pdos + 0, EC_WD_ENABLE},
    {1, EC_DIR_INPUT, 1, slave_7_pdos + 1, EC_WD_DISABLE},
    {0xff}
};
...
ec_pdo_info_t slave_8_pdos[] = {
    {0x1600, 7, slave_8_pdo_entries + 0}, /* Outputs */
    {0x1a00, 8, slave_8_pdo_entries + 7}, /* Inputs */
};
