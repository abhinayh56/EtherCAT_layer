...
Ec_slave_5::Ec_slave_5(uint16_t slave_address_, const std::string &slave_name_)
{
...
void Ec_slave_5::set_pdo()
{
    domain_i_regs = domain_regs;
}

void Ec_slave_5::monitor_status()
{
}
...
void Ec_slave_5::process_tx_pdo()
{
}

void Ec_slave_5::process_rx_pdo()
{
}

void Ec_slave_5::config_data_transfer()
{
}

void Ec_slave_5::publish_data()
{
}

void Ec_slave_5::subscribe_data()
{
}
