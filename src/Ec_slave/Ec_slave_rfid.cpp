...
uint16_t Ec_slave_rfid::transfer_tx_pdo()
{
    ...
    std::cout << slave_ns << ": " << 
        m_tx_pdo.Device_ID.offset << ", " <<
        m_tx_pdo.Second.offset << ", " <<
        m_tx_pdo.Minute.offset << ", " <<
        m_tx_pdo.Hour.offset << ", " <<
        m_tx_pdo.Day.offset << ", " <<
        m_tx_pdo.Month.offset << ", " <<
        m_tx_pdo.Year.offset << ", " <<
        m_tx_pdo.Roll_Offset.offset << ", " <<
        m_tx_pdo.Pitch_Offset.offset << ", " <<
        m_tx_pdo.Yaw_Offset.offset << ", " <<
        m_tx_pdo.Grip_Offset.offset << ", " <<
        m_tx_pdo.No_of_Usages.offset << ", " <<
        m_tx_pdo.Max_Usages.offset << ", " <<
        m_tx_pdo.Digital_Inputs.offset << ", " <<
        m_tx_pdo.Grip_Counts.offset << ", " <<
        m_tx_pdo.System_Number.offset << ", " <<
        m_tx_pdo.Device_UID.offset << ", " <<
        m_tx_pdo.Spare_Bytes.offset << ", " <<
        m_tx_pdo.MFG_Day.offset << ", " <<
        m_tx_pdo.MFG_Month.offset << ", " <<
        m_tx_pdo.MFG_Year.offset << ", " <<
        std::endl;
