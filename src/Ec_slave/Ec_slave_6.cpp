#include "Ec_slave_6.h"

Ec_slave_6::Ec_slave_6(uint16_t slave_address_, const std::string &slave_name_)
{
    slave_address = slave_address_;
    slave_name = slave_name_;
}

Ec_slave_6::~Ec_slave_6()
{
}

void Ec_slave_6::set_info()
{
...
void Ec_slave_6::set_pdo()
{
    domain_i_regs = domain_regs;
}

void Ec_slave_6::monitor_status()
{
}

void Ec_slave_6::transfer_tx_pdo()
{
...
void Ec_slave_6::transfer_rx_pdo()
{
    t_stamp += 4;
...
void Ec_slave_6::process_tx_pdo()
{
}

void Ec_slave_6::process_rx_pdo()
{
}

void Ec_slave_6::config_data_transfer()
{
}

void Ec_slave_6::publish_data()
{
}

void Ec_slave_6::subscribe_data()
{
}
